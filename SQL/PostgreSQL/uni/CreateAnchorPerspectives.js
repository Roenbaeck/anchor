...
/*~
    ON $attribute.mnemonic\.$attribute.entityReferenceName = $anchor.mnemonic\.$anchor.identityColumnName~*/
            if(attribute.isKnotted()) {
                knot = attribute.knot;
...
/*~
          SELECT DISTINCT $attribute.entityReferenceName AS $anchor.identityColumnName
